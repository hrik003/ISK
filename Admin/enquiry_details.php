    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Enlist Enquiry
            <small> see all your enquiries here</small>
          </h1>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <!--<form class="form-horizontal" method="post" action="insert_contact.php">
                    ...
                    <legend> List of Enquiries </legend>
                    <div>
                <!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody> 
                    <?php $showqry  = mysql_query("SELECT * FROM contact_us") ;
					while($row = mysql_fetch_row($showqry))
					{
					?>
                    	<tr>
                        <td><a href="edit_enquiry.php?id=<?php echo $row[0] ?>"><?php echo $row[1] ?></a></td>
                        <td><?php echo $row[2] ?></td>
                        <td><?php echo $row[3] ?></td>
                       
                        <td>
                        	<a href="del_enquiry.php?id=<?php echo $row[0] ?>" onClick="return confirm('are you sure?')"> <i class="fa fa-trash"></i> Delete</a>
                        </td>
                      </tr>
                      <?php
					}
