   ...
   <?php include "component/header.php" ?> <!-- header --->
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Customer View list
            <small>Submit the views of customer</small>
          </h1>
...
//					}
					...
					?>
                       ...
                       <td><a href="cust_view.php?orderid=<?php echo $fetchordrow[0] ?>&mail=<?php echo $fetchordrow[9] ?>" > <?php echo $fetchordrow[0] ?></a></td>
