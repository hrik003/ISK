...
<html>
  <head>
    ...
    <title>Goods delivery varification List</title>
...
//					
					...
					?>
						...
						<td><a href="good_verify.php?orderid=<?php echo $fetchordrow[0] ?>"> <?php echo $fetchordrow[0] ?></a></td>
