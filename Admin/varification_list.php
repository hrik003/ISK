...
//					}
					...
					?>
                    	...
                    	<tr> 
                        <?php if($fetchordrow[8]==0){?>
						<td><a href="quality_verification.php?orderid=<?php echo $fetchordrow[0] ?>"> <?php echo $fetchordrow[0] ?></a></td>
                        <?php } else {?>
                       <td><a href="verify_details.php?orderid=<?php echo $fetchordrow[0] ?>"  style="color:#078F1B"> <?php echo $fetchordrow[0] ?></a></td>
                        <?php } ?> 
                        ...
                        <td><?php echo setstatus($fetchordrow[6]) ?></td>
                     	<td><?php echo varstat($fetchordrow[8]) ?></td>
